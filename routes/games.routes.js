 ...
 * tags:
 *   - name: Games
 *     description: Futbol o‘yinlari uchun CRUD API
 */
 ...
 *               $ref: '#/components/schemas/Game'
 */
// O'yin uchun rasm yuklash (galereyadan) — /:id dan oldin bo'lishi kerak
router.post("/upload-image", upload.single("image"), gameController.uploadGameImage);
router.post("/", gameController.createGame);
